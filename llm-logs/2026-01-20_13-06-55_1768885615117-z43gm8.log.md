...
**Session ID**: `1768885615117-z43gm8`
**Timestamp**: 2026-01-20T05:06:55.117Z
...
| +0.02s | 📝 KEYWORD FALLBACK | RAG not ready (0/11) |
...
| +25.53s | ✍️ PROMPT BUILDING | Building system prompt |
| +25.54s | 📤 LLM REQUEST | Sending request to LLM |

---

## LLM Call #1

**Timestamp**: 2026-01-20T05:07:20.655Z
...
| +25.54s | ⏳ WAITING FOR LLM | Waiting for LLM response |
| +36.27s | ❌ ERROR | fetch failed |

---

## Final Result

**Total Time**: 36.27 seconds
**Status**: ❌ Failed
