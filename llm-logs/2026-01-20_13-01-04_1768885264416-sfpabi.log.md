...
**Session ID**: `1768885264416-sfpabi`
**Timestamp**: 2026-01-20T05:01:04.416Z
...
| +0.01s | 📝 KEYWORD FALLBACK | RAG not ready (0/11) |
...
| +26.14s | ✍️ PROMPT BUILDING | Building system prompt |
| +26.15s | 📤 LLM REQUEST | Sending request to LLM |

---

## LLM Call #1

**Timestamp**: 2026-01-20T05:01:30.568Z
...
| +26.15s | ⏳ WAITING FOR LLM | Waiting for LLM response |
| +36.76s | ❌ ERROR | fetch failed |

---

## Final Result

**Total Time**: 36.76 seconds
**Status**: ❌ Failed
